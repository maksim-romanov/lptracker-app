...
// than reporting, and it carries the whole weight of a first visit.
const BLOBS = [
  ...
  <div class="relative overflow-hidden rounded-lg bg-primary-container px-6 py-10 text-center">
    ...
    <div class="relative flex flex-col items-center gap-4">
      <div class="flex flex-col gap-2">
        <h2 class="text-headline text-on-primary-container">Watch a wallet without connecting it</h2>
        <p class="text-body-small text-on-primary-container">Paste an address and Depthly starts tracking. Nothing is signed.</p>
      </div>
      <Button
