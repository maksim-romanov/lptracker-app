...
export type PositionQuery = {
  ...
  position?: {
    ...
    pool?: {
      ...
      currentTick: number;
      sqrtPriceX96: any;
      token0: { __typename?: "Token"; id: string; symbol: string; decimals: number };
      token1: { __typename?: "Token"; id: string; symbol: string; decimals: number };
    } | null;
  } | null;
};
...
export type WalletPositionsQuery = {
  __typename?: "Query";
  positions: Array<{
    __typename?: "Position";
    id: string;
