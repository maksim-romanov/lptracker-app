...
export function renderPositionDetail(position: TGatewayPosition, tokens: TTokensMap): ReactNode {
  switch (position.extension.type) {
    case "uniswap-v3":
      return <UniswapV3PositionDetail position={position as TPositionByExt<"uniswap-v3">} tokens={tokens} />;
    default:
