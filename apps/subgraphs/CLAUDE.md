...
The Graph indexers, one AssemblyScript package per protocol: [`uniswap-v3`](uniswap-v3/CLAUDE.md), [`uniswap-v4`](uniswap-v4/CLAUDE.md), [`slipstream`](slipstream/CLAUDE.md). No workspace dependencies — fully standalone from the rest of the monorepo.
